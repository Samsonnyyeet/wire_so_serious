...
df['Target'] = (df['Memory Usage (%)'] > 90).astype(int)  


features = ['Memory Usage (%)', 'Memory Usage (MB)', 'Memory Requests (%)', 'Active Memory Limits (MB)emory Limits Utilization (%)',
            'CPU Usage (%)', 'Pod Restarts', 'time_since_last_record', 'day', 'hour', 'minute']
cat_features = ['Pod Status', 'Pod Event Type', 'Pod Event Reason', 'Node Name']
...
torch.save(model.state_dict(), 'memory_exhaustion_model.pth')